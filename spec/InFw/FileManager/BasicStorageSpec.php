...
{
    const ROOT_FOLDER = __DIR__ . '/../../assets/tmp/';
    ...
    {
        $file = (new Prophet())->prophesize(FileInterface::class);
        $file->getName()->willReturn(self::NAME);
        $file->getTmpName()->willReturn(self::TMP_NAME.'fakefake');

        if (!is_dir(__DIR__ . '/../../assets/tmp/fake/')) {
            mkdir(__DIR__ . '/../../assets/tmp/fake/');
        }
        ...
        if (file_exists(__DIR__ . '/../../assets/tmp/fake/')) {
            rmdir(__DIR__ . '/../../assets/tmp/fake/');
        }
